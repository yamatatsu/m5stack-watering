...
bargraph0 = M5BarGraph(20, 141, 280, 30, 0, 500, M5BarGraph.HORIZON, False, 0x0288FB, 0xFFFFFF)
label0 = M5Label('label0', x=102, y=69, color=0x000, font=FONT_MONT_38, parent=None)
...
while True:
  ...
  bargraph0.addSample(2100 - (Watering_0.get_adc_value()))
